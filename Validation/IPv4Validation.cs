...
namespace Validation
{
    class IPv4Validation : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            if (Regex.IsMatch(value.ToString(), @"^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"))
                ...
                return new ValidationResult(false, "Bitte gib eine valide IPv4-Adressse ein!");
        }
    }


    class ValidationExtension : MarkupExtension
    {
    ...
    class ValidationRuleCollection : Collection<ValidationRule> { }
}
